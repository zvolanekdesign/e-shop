...
function showCustomizer(product) {
  ...
  const info = document.getElementById('customizer-product-info');
  if (info) info.innerHTML = buildDetailsHtml(product);
...
function openCustomizer(product) {
  ...
  url.searchParams.set('view', 'customizer');
...
preloadSkins().then(() => {
  ...
  if (sku && params.get('view') === 'customizer') {
    document.querySelector('header.site-header')?.style.setProperty('display','none');
    document.querySelector('.hero')?.style.setProperty('display','none');
    document.querySelector('.steps')?.style.setProperty('display','none');
    document.querySelector('.products')?.style.setProperty('display','none');
    document.querySelector('.cart-section')?.style.setProperty('display','none');
    document.querySelector('.checkout')?.style.setProperty('display','none');
    document.querySelector('footer.site-footer')?.style.setProperty('display','none');
    const product = PRODUCTS.find(p => p.sku === sku);
    if (product) showCustomizer(product);
  }
}).catch(() => {
